...
if(isset($_POST['submit']) && $_POST['submit']=="add")
{
	...
	$salient_feature = isset($_POST['tmb_height']) ? $_POST['tmb_height'] : '';
    // $comparison = isset($_POST['comparison']) ? $_POST['comparison'] : '';
          ...
          <input type="text" size="4" placeholder="Height" name="tmb_height" value="<?php echo $tmb_height; ?>">
                ...
                <div class="col-md-12">
                 <label class="input-text">Cate/Prod Small Description</label>
                  <div class="form-group">
                      <textarea name="small_description" class="ckeditor" class="from-control custom-type" placeholder="Cate/Prod Small Description" rows="5" cols="5"><?php echo $small_description; ?></textarea>
                   </div>
                  </div>  
                ...
                <br>
                 <div class="col-md-12">
                  ...
                  <div class="form-group">
                      <textarea name="tmb_height" id="tmb_height" class="ckeditor" class="from-control custom-type" placeholder="Salient Feature" rows="10" cols="180"><?php echo $tmb_height;?></textarea>
                   </div>
